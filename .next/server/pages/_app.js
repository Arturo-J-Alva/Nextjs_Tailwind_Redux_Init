...
/* harmony default export */ var loginReducer = ((state = INIT_STATE, action) => {
  switch (action.type) {
    case SAVE_LOGIN:
...
var tailwind = __webpack_require__("OEcT");
...
const store = Object(external_redux_["createStore"])(reducers, //todo los reducers
{}, //estado inicial
Object(external_redux_["applyMiddleware"])(external_redux_thunk_default.a) //Middleware
);
